...
public enum LayerPreset: String, CaseIterable, Identifiable, Codable, Equatable {
    ...
    public var kinds: [LayerKind] {
        switch self {
        case .two_DressShoes: return [.dress, .shoes]
        case .three_TopBottomShoes: return [.top, .bottom, .shoes]
        case .four_TopBottomOuterwearShoes: return [.top, .bottom, .outerwear, .shoes]
        case .five_TopBottomOuterwearShoesBag: return [.top, .bottom, .outerwear, .shoes, .bag]
        case .six_TopBottomOuterwearShoesBagAccessory: return [.top, .bottom, .outerwear, .shoes, .bag, .accessory]
        }
    }
